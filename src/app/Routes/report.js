...
export const eg_report = {
    path: '/report/energy',
    component: () => import( /* webpackChunkName: "eg_report" */ '../pages/report/energy' ),
}

export const ab_report = {
    path: '/report/ambience',
    component: () => import( /* webpackChunkName: "ab_report" */ '../pages/report/ambience' ),
}

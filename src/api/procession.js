...
export const route_auto_add = ajax.fetchJSONByPost( 'api/procession/route/NewRoutineAutoConfigStamping' )
export const route_auto_delete = ajax.fetchJSONByPost( 'api/procession/route/DeleteRoutine' )
...
export const config_device = ajax.fetchJSONByPost( 'api/procession/config_device/list' )
export const config_device_update = ajax.fetchJSONByPost( 'api/procession/config_device/update' )
...
export const procedure_list = ajax.fetchJSONByPost( 'api/procession/procedure/list' )
export const procedure_update = ajax.fetchJSONByPost( 'api/procession/procedure/update' )
export const procedure_add = ajax.fetchJSONByPost( 'api/procession/procedure/add' )
export const procedure_delete = ajax.fetchJSONByPost( 'api/procession/procedure/delete' )
